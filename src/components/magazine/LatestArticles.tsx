  ...
  return (
    <section id="articles" className="py-16 md:py-24 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Category Tabs */}
        <div className="flex gap-2 overflow-x-auto pb-4 mb-10 scrollbar-hide -mx-4 px-4">
                ...
                >
                  ...
                  >
                    ...
                    <CardContent className="p-5 flex flex-col flex-1">
                      <h3 className="font-bold mb-2 group-hover:text-primary transition-colors line-clamp-2 leading-snug text-sm">
                        {article.title}
                      </h3>
